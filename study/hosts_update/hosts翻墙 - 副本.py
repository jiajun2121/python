...
if __name__ == '__main__':
    ...
    os.system(r'type 源hosts.txt > "%SystemRoot%\System32\drivers\etc\hosts"')
    if os.path.exists(r'补充hosts.txt'):
        os.system(r'type 补充hosts.txt >> "%SystemRoot%\System32\drivers\etc\hosts"')
        print('echo 补充hosts已加入')
    os.system(r'echo ' + update_log)
    os.system(r'echo ' + update_log + ' >> log.log')
